        ...
        <table class="table table-sm">
          ...
          <tbody>
            <tr v-for="user in usersDataDisplay" :key="user.id">
              <th scope="row">{{ user.store_name }}</th>
        ...
        <form @submit.prevent="submitRegisterUser">
          <div class="modal-content">
            <div class="modal-header bg-success text-white modal-header-edit">
              <h5 class="modal-title text-white" id="exampleModalLabel">Add Store</h5>
              <button
                type="button"
                  ...
                  <div class="mx-2">
                    ...
                    <div class="form-group mb-2">
                      ...
                      <input
                        ...
                        aria-describedby="store_name"
                        placeholder="Enter store name"
                        v-model="userDataEdit.store_name"
                      />
                      <small v-if="error.store_name" class="form-text text-danger">{{
                        error.store_name
                      }}</small>
...
const submitRegisterUser = () => {
  ...
  if (userData.value.store_name.length == 0) {
    error.value.store_name = 'Please enter your id number.'
    isValid = false
  }
...
const submitUpdateUser = () => {
  ...
  if (userDataEdit.value.store_name.length == 0) {
    error.value.store_name = 'Please enter your id number.'
    isValid = false
  }
