        ...
        <div class="col">
          <div class="row">
            <div class="col py-5">
              ...
              <div class="">
                <p class="py-2">
                  Welcome to your Food Ordering Dashboard! Order your favorites with ease and enjoy
                  delicious food at your fingertips. Let us take care of the rest.
                </p>
              </div>
            </div>
          </div>
...
const getPurchases = () => {
  productStore
    ...
    .then((data) => {
      ...
      newOrder.value = purchases.value.filter((data) => {
        return data.status === 'New'
      })

      preparing.value = purchases.value.filter((data) => {
        return data.status === 'Preparing'
      })

      ready.value = purchases.value.filter((data) => {
        return data.status === 'Ready'
      })

      toPickUp.value = purchases.value.filter((data) => {
        return data.status === 'To Pick up'
      })

      forDelivery.value = purchases.value.filter((data) => {
        return data.status === 'For Delivery'
      })

      done.value = purchases.value.filter((data) => {
