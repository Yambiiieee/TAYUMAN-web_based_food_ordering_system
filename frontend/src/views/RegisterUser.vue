  ...
  <div class="bg-img">
    <div class="container">
      <div class="row d-flex justify-content-center">
        <div class="col-md-10 py-5 card mt-5 px-4">
          <div class="">
            <h4 class="text-center">Register to Tayuman</h4>
          </div>
          <form
            @submit.prevent="submitRegister"
            class="mt-2 row d-flex justify-content-between mx-2"
          >
            <div class="col-md-5">
              <!-- INPUT START -->
              <div class="form-group mb-2">
                ...
                <input
                  ...
                  id="id_number"
                  aria-describedby="id_number"
                  placeholder="Enter id number"
                  v-model="userData.id_number"
                />
                <small v-if="error.id_number" class="form-text text-danger">{{
                  error.id_number
                }}</small>
              </div>
              <!-- INPUT END -->
        ...
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title text-white" id="exampleModalLabel">
              Tayuman Store Terms And Condition
            </h5>
          </div>
          <div class="modal-body px-5">
            <h5>User Registration</h5>
            <p>
              Your information will be collected and securely stored for the purpose of providing
              our services to you.
            </p>
            ...
            <ul>
              <li>
                <strong>User Registration:</strong> Your information will be collected and securely
                stored for the purpose of providing our services to you.
              </li>
              <li>
                <strong>User Account:</strong> You are responsible for maintaining the
                confidentiality of your Account login credentials.
              </li>
              <li>
                <strong>User Responsibilities:</strong> You agree to comply with all applicable
                laws, regulations, and these Terms while using the Platform.
              </li>
              <li>
                <strong>Intellectual Property:</strong> All intellectual property rights in the
                Platform and its content belong to Tayuman Food Store.
              </li>
              <li>
                <strong>Limitation of Liability:</strong> Tayuman Food Store is not liable for any
                damages arising from your use of the Platform or its services.
              </li>
              <li>
                <strong>Governing Law:</strong> These Terms are governed by the laws of [Insert
                applicable jurisdiction].
              </li>
            </ul>
            <p>
              Please note that by registering as a user, you indicate your acceptance of these Terms
              and Conditions.
            </p>
          </div>
...
const sendVerificationCode = () => {
  ...
  if (userData.value.email.length == 0) {
    // if (userData.value.email.length == 0 || !validEmail.test(userData.value.email)) {
...
const submitRegister = () => {
  ...
  if (userData.value.id_number.length == 0) {
    error.value.id_number = 'Please enter your id number.'
    isValid = false
  }
